...
export default function DayManager({day, setDay}) {
    ...
    return (
            <div className="date-container d-flex justify-content-center align-items-center col-4">
                <button type="button" className="btn left-arrow" onClick={onClick(-1)}>←</button>
                <p className="h2 mb-0 date">{formatter.format(day)}</p>
                <button type="button" className="btn right-arrow" onClick={onClick(1)}>→</button>
            </div>
    )
}